# Day 04 - Accessible Rolls Grid
# Part A: Count rolls (@) that have fewer than 4 neighbors (immediately accessible).
# Part B: Count total rolls that can eventually be removed by repeatedly removing
#         accessible rolls (those with fewer than 4 neighbors).
